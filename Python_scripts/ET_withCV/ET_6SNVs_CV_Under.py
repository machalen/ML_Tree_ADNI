...
fscore_df.to_csv(os.path.join(outDir, 'ET.6SNVs.fscore.Under.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'ET.6SNVs.roc.Under.CV.txt'), index=None, sep='\t')
