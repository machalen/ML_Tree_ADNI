...
fscore_df.to_csv(os.path.join(outDir, 'ET.6SNVs.fscore.ADNI.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'ET.6SNVs.roc.ADNI.CV.txt'), index=None, sep='\t')
