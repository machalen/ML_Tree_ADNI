...
fscore_df.to_csv(os.path.join(outDir, 'ET.9SNVs.fscore.ADNI.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'ET.9SNVs.roc.ADNI.CV.txt'), index=None, sep='\t')
