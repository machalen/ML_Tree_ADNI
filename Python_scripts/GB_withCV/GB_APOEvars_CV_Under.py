...
fscore_df.to_csv(os.path.join(outDir, 'GB.APOEvars.fscore.Under.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'GB.APOEvars.roc.Under.CV.txt'), index=None, sep='\t')
