...
print ('Train set:', X_train.shape,  y_train.shape)#Train set: (296, 2) (296,)
print ('Test set:', X_test.shape,  y_test.shape)#Test set: (74, 2) (74,)
...
fscore_df.to_csv(os.path.join(outDir, 'GB.APOEvars.fscore.ADNI.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'GB.APOEvars.roc.ADNI.CV.txt'), index=None, sep='\t')
