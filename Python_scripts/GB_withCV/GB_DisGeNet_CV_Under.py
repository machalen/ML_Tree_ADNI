...
fscore_df.to_csv(os.path.join(outDir, 'GB.DisGeNet.fscore.Under.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'GB.DisGeNet.roc.Under.CV.txt'), index=None, sep='\t')
