...
fscore_df.to_csv(os.path.join(outDir, 'GB.20SNVs.fscore.ADNI.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'GB.20SNVs.roc.ADNI.CV.txt'), index=None, sep='\t')
