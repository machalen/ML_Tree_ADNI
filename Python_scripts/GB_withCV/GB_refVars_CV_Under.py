...
fscore_df.to_csv(os.path.join(outDir, 'GB.refVars.fscore.ADNI.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'GB.refVars.roc.ADNI.CV.txt'), index=None, sep='\t')
