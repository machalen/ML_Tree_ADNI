...
fscore_df.to_csv(os.path.join(outDir, 'RF.refVars.fscore.ADNI.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'RF.refVars.roc.ADNI.CV.txt'), index=None, sep='\t')
