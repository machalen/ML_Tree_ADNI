...
fscore_df.to_csv(os.path.join(outDir, 'RF.6SNVs.fscore.Under.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'RF.6SNVs.roc.Under.CV.txt'), index=None, sep='\t')
