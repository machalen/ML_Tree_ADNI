...
fscore_df.to_csv(os.path.join(outDir, 'RF.DisGeNet.fscore.Under.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'RF.DisGeNet.roc.Under.CV.txt'), index=None, sep='\t')
