...
fscore_df.to_csv(os.path.join(outDir, 'RF.DisGeNet.fscore.ADNI.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'RF.DisGeNet.roc.ADNI.CV.txt'), index=None, sep='\t')
