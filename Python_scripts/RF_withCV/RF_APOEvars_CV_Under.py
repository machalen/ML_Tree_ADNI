...
fscore_df.to_csv(os.path.join(outDir, 'RF.APOEvars.fscore.ADNI.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'RF.APOEvars.roc.ADNI.CV.txt'), index=None, sep='\t')
