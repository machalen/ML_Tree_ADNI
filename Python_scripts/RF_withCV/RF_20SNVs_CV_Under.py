...
fscore_df.to_csv(os.path.join(outDir, 'RF.20SNVs.fscore.ADNI.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'RF.20SNVs.roc.ADNI.CV.txt'), index=None, sep='\t')
